...
ElementIteratorPtr AABBGeometry::getCloseElementsIterator(const ConstraintProximityPtr P) {
    std::set<int> selectElements;
    getCloseElements(P,selectElements);

    return ElementIteratorPtr(new ElementAABBIterator(selectElements));
}
