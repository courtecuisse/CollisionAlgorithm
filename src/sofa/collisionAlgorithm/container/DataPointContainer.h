...
//class DataPointElement : public DataElemnt<sofa::core::topology::BaseMeshTopology::Triangle> {
//public:
...
//        return BaseProximity::create<TriangleProximity>(m_geometry->getState(),triangle[0],triangle[1],triangle[2],factor[0],factor[1],factor[2],m_triangle_normals[tid]);
//    }
...
//        return BaseProximity::create<TriangleProximity>(m_geometry->getState(),triangle[0],triangle[1],triangle[2],0.3333,0.3333,0.3333,m_triangle_normals[tid]);
//    }
