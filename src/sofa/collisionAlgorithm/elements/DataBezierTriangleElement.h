...
public:
    ...
    , d_nonlin_threshold(dynamic_cast<sofa::core::objectmodel::BaseObject*>(init.owner)->initData(&d_nonlin_threshold,(double) 0.00001,"nonlin_th", "Threshold"))
    , d_draw_tesselation(dynamic_cast<sofa::core::objectmodel::BaseObject*>(init.owner)->initData(&d_draw_tesselation,(unsigned) 0.0, "tesselation", "Number of tesselation"))
    {}
