...
//    typedef typename GEOMETRY::TriangleInfo TriangleInfo;
//    typedef typename DataTypes::Coord Coord;
//    typedef typename DataTypes::VecCoord VecCoord;
//    typedef Data<VecCoord> DataVecCoord;
//    typedef sofa::core::behavior::MechanicalState<DataTypes> State;

//    TriangleElement(const GEOMETRY * geo)
//    : m_geometry(geo) {
...
//        return BaseProximity::SPtr(new PROXIMITY(id(), triangle[0],triangle[1],triangle[2], factor[0],factor[1],factor[2],m_geometry,m_state));
//    }
...
//        return BaseProximity::SPtr(new PROXIMITY(id(), triangle[0],triangle[1],triangle[2],0.3333,0.3333,0.3333,m_geometry,m_state));
//    }
