...
public:
    ...
    static typename BaseProximity::SPtr createCenterProximity(EdgeElement::SPtr edge) {
        return EdgeProximity::create(edge,0.5,0.5);
    }

    static BaseProximity::SPtr project(const type::Vector3 & P, EdgeElement::SPtr edge) {
